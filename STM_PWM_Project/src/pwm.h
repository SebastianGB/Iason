 ...
 * @param[in]	en				The clock to enable the timer. E.g. RCC_APB1ENR_TIM2EN.
 * @param[in]	prescaler		The prescaler value to use. A prescaler devides the system clock speed.
 *								E.g. a prescaler of 2 scales a 72Mhz clock down to 36Mhz.
 * @param[in]	period			The period of the PWM. The period ends when the timers counter has reached the value given here.
...
/**
 * Initialize a single output channel for a timer. This function also intializes the GPIOs tight to the timers output channel.
 *
 ...
 *
 * @param[in]	timer_peripheral	The timer for which the output channel is to be set. E.g. TIM2.
 * @param[in]	oc_id				The ID of the timers output channel. E.g. TIM_OC1.
